...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/bache.png', 90, 300, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 101, 471, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 560, 479, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 540, 229, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 870, 227, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 293, 249, 30, 15, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 759, 389, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 857, 389, 30, 30, 1)   
...
siguiente forma: {desdeX: valor, hastaX: valor, desdeY: valor, hastaY: valor} */
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 70, 430, 20, 20, 1, {desdeX: 70, hastaX: 582, desdeY: 430, hastaY: 470}),
    new ZombieCaminante('imagenes/zombie2.png', 297, 93, 20, 20, 2, {desdeX: 297, hastaX: 630, desdeY: 91, hastaY: 95}),
    new ZombieCaminante('imagenes/zombie3.png', 762, 406, 20, 20, 1, {desdeX: 762, hastaX: 870, desdeY: 406, hastaY: 408}),
    new ZombieCaminante('imagenes/zombie4.png', 70, 400, 20, 20, 1, {desdeX: 70, hastaX: 870, desdeY: 400, hastaY: 420}),
    new ZombieCaminante('imagenes/zombie1.png', 70, 190, 20, 20, 1, {desdeX: 70, hastaX: 943, desdeY: 200, hastaY: 220}),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 3, {desdeX: 644, hastaX: 644, desdeY: 0, hastaY: 470}, "v"),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 1, {desdeX: 678, hastaX: 678, desdeY: 0, hastaY: 470}, "v"),
    new ZombieConductor('imagenes/tren_horizontal.png', 0, 322, 90, 30, 5, {desdeX: 0, hastaX: 943, desdeY: 322, hastaY: 322}, "h")
  ],
  aliados: [
    new Aliado('imagenes/gasolinax1.png', 315, 206, 15, 15, 1),
    new Aliado('imagenes/gasolinax5.png', 831, 139, 15, 15, 5),
    new Aliado('imagenes/gasolinax5.png', 165, 392, 15, 15, 5)
  ]
}
...
Juego.iniciarRecursos = function() {
  Resources.load([
    ...
    'imagenes/meta.png',
    'imagenes/gasolinax1.png',
    'imagenes/gasolinax5.png',
    'imagenes/Mensaje1.png',
    'imagenes/Mensaje2.png',
    'imagenes/transparent.png'
  ]);
...
Juego.capturarMovimiento = function(tecla) {
  ...
  this.jugador.cambiarFrente(tecla);
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarImagen('imagenes/meta.png',758,519,130,45);
  ...
  this.aliados.forEach(function(aliado) {
    Dibujante.dibujarEntidad(aliado);
  });
...
Juego.chequearColisiones = function(x, y) {
  ...
  this.obstaculos().forEach(function(obstaculo) {
    if (this.intersecan(obstaculo, this.jugador, x, y)) {
      obstaculo.chocar(this.jugador.vidas);
      puedeMoverse = false
    }
  }, this);

  this.aliados.forEach(function(aliado) {
    if (this.intersecan(aliado, this.jugador, x, y)) {
      aliado.sumarVida(this.jugador.vidas);      
    }
  }, this);
  return puedeMoverse;
};
...
Juego.dibujarFondo = function() {  
  ...
  if (this.terminoJuego()) {
    ...
    this.jugador.sprite = 'imagenes/transparent.png';
    this.jugador.x = 2000;
    this.meta.sprite = 'imagenes/transparent.png';   
  }
